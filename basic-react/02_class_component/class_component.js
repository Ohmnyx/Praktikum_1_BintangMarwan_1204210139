...
// Class Component
class Practice1 extends React.Component { //tidak menggunakan props tetapi menggunakan extend
    render() {
...
class Practice2 extends React.Component { //Menggunakan props
    render() {
        return <h3>Practice: {this.props.topic}</h3>
    }
}
myElement = <Practice2 topic="ReactJS"/>; //ini propsnya
